...
copy /y "%WXBINARIESPATH%\wxmsw30u_core_vc_custom.dll" "%HEEKSCADPATH%"
copy /y "%WXBINARIESPATH%\wxmsw30u_aui_vc_custom.dll" "%HEEKSCADPATH%"
copy /y "%WXBINARIESPATH%\wxbase30u_vc_custom.dll" "%HEEKSCADPATH%"
rem TBB
