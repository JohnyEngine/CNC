...
IF( NOT OpenCASCADE_FOUND STREQUAL TRUE )
  ...
  ELSE(UNIX)
    IF (WIN32)
      set( _incsearchpath $ENV{CASROOT}\\inc D:\\OpenCASCADE\\OpenCASCADE-6.9.1\\inc )
      set( _testlibname TKernel.lib )
      set( _libsearchpath $ENV{CASROOT}\\win32\\${MSVER_STR}\\lib D:\\OpenCASCADE\\OpenCASCADE-6.9.1\\win32\\${MSVER_STR}\\lib )
    ENDIF (WIN32)
  ENDIF (UNIX)
