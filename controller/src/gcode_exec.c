...
uint8_t cnc_line(double x, double y, double z, double extruder_length, 
 ...
 int32_t newX = _lround(x*SM_X_STEPS_PER_MM), newY = _lround(y*SM_Y_STEPS_PER_MM);
 int32_t newZ = _lround(z*SM_Z_STEPS_PER_MM), newE = _lround(extruder_length*SM_E_STEPS_PER_MM);
